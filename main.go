...
Options: 
	...
	delete:  Searches the library by the input book ID given by the user after the command. If the ID matches any of the books, set its library status to deleted.
